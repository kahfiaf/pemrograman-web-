...
old_html_start = '<div style="font-family: Arial, sans-serif; font-size: 8pt; color: #111; background: #fff;">'
new_html_start = '<div id="pdf-container" style="width: 800px; font-family: Arial, sans-serif; font-size: 8pt; color: #111; background: #fff; padding: 20px;">'
text = text.replace(old_html_start, new_html_start)

# Replace the PDF call
old_pdf_call = '''        const pdfNode = document.createElement('div');
...
print('Reverted to from(htmlContent) successfully!')
