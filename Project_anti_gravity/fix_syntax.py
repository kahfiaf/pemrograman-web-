...
start_marker = "        if (type === 'pipeline') {"
end_marker = "        overlay.style.display = 'flex';"
...
if start_idx != -1 and end_idx != -1:
    ...
    new_block = """        if (type === 'pipeline') {
            ...
            if (c) {
                ...
                dynStr = "Skor awal: <strong>" + fs + "%</strong>, skor terbaru: <strong>" + ls + "%</strong> (" + (df >= 0 ? "naik" : "turun") + " " + absDf + "%).";
            }
